...
def turtle4():
    darko = rg.SimpleTurtle()
    darko.pen = rg.Pen('red', 10)

    darko.draw_square(100)


def turtle5():
    blinky = rg.SimpleTurtle('turtle')
    inky = rg.SimpleTurtle('turtle')

    blinky.pen = rg.Pen('PeachPuff', 5)
    blinky.speed = 20
    blinky.draw_regular_polygon(5,50)

    inky.pen = rg.Pen('peru', 5)
    inky.speed = 20
    inky.draw_regular_polygon(10,50)
